...
namespace reshade::d3d11
{
		...
		_stateblock(device)
	{
		...
		if(DllModule::isValid) DllModule::module->RegisterDrawFxFunc_11(this->do_draw_fx);
	}
	...
	void d3d11_runtime::do_draw_fx(void* runtime)
	{
		((d3d11_runtime*)runtime)->draw_fx();
	}
	void d3d11_runtime::draw_fx()
	{
